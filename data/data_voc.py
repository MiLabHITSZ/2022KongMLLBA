...
import pickle
from ml_gcn_model import util
from ml_gcn_model import *
...
class Voc2007Classification(data.Dataset):
    def __init__(self, root, set, transform=None, target_transform=None, inp_name=None, adj=None):
        ...
        file_csv = os.path.join(path_csv, 'files','VOC2007','classification_' + set + '.csv')
...
class Voc2012Classification(data.Dataset):
    def __init__(self, root, set, transform=None, target_transform=None, inp_name=None, adj=None):
        ...
        path_csv = os.path.join(self.root)
        # define filename of csv file
        file_csv = os.path.join(path_csv, 'files','VOC2012','classification_' + set + '.csv')
