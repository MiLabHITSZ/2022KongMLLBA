...
parser.add_argument('--batch_size', default=10, type=int,
                    metavar='N', help='batch size for traning(default: 100)')
...
parser.add_argument('--save_image_folder', default="GCN_2007", type=str, metavar='N',
...
def evaluate_adv(state):
    ...
    adv_dataset = Voc2007Classification(args.data, 'mlgcn_adv',
                                        inp_name='../data/voc2007/voc_glove_word2vec.pkl')
...
def main():
    ...
    ori_dataset = Voc2012Classification('../data/voc2012', 'val', inp_name='../data/voc2012/voc_glove_word2vec.pkl')
