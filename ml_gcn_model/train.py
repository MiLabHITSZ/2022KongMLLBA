...
print(torch.cuda.device_count())
import argparse
from ml_gcn_model.engine import *
from ml_gcn_model.models import *
from ml_gcn_model.voc import *
...
parser.add_argument('--resume', default='../checkpoint/mlgcn/NUSWIDE/model_best.pth.tar', type=str, metavar='PATH',
...
def main_nuswide():
    ...
    train_dataset = NusWide(args.data,  phase='train', inp_name='../data/NUSWIDE/glove_word2vec.pkl')
    val_dataset = NusWide(args.data, phase= 'val', inp_name='../data/NUSWIDE/glove_word2vec.pkl')
